...
<aside class="main-sidebar fixed offcanvas shadow">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="#"><i class="icon icon-users blue-text s-18"></i>Covid-19<i
                    class="icon icon-angle-left s-18 pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="<?=base_url();?>user/"><i class="icon icon-document-table"></i>Tampilan Tabel</a>
                    </li>
                    <li><a href="<?=base_url();?>user/add"><i class="icon icon-add"></i>Tambah Pasien Covid-19</a>
                    </li>
