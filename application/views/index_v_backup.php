      ...
      <div style="display: flex; flex-direction:row;" bis_skin_checked="1">
        <img src="<?= base_url();?>assets-front/img/logo.png" style="height:4rem; float:left;">
          ...
          <span style="color: #fff;">
            <span class="logo mr-auto" style="font-size: 14px">SATGAS COVID-19</span><br>
      ...
      */             
      function graph(data){
        ...
        var kasustotal = {
            ...
            colors: [chartColors.orange, chartColors.blue, chartColors.purple, chartColors.red2, chartColors.red],
            // stroke: {
            //     width: [0, 5, 5, 5],
            ...
            legend: {
                ...
                markers: {
                    ...
                    strokeWidth: 0,
                    //strokeColor: '#fff',
                    fillColors: [chartColors.orange, chartColors.blue, chartColors.purple, chartColors.red2, chartColors.red],
                    radius: 12,
      ...
      function update_maps(hal){
        url_jsaon = "<?= base_url();?>home/get_data_user/?hal="+hal;
        var hasilpasien=$.getJSON(url_jsaon, function (data) {
        for (var i = 0; i < data.length; i++) {
            var lat =data[i].latitude;
            var lng =data[i].longitude;
