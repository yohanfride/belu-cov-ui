    ...
    <section class="sidebar">
        ...
        <div class="relative">
            <a data-toggle="collapse" href="#userSettingsCollapse" role="button" aria-expanded="false"
               aria-controls="userSettingsCollapse" class="btn-fab btn-fab-sm fab-right fab-top btn-primary shadow1 " style="padding-top: 8px;">
                ...
                <div class="col">
                    <div class="card text-white bg-danger mb-3 no-b">
                        ...
                        <div class="card-body text-danger">
                            ...
                            <p class="card-text">Data pasien tidak ada atau tidak terdaftar, silahkan hubungi pihak administrator atau pastikan QRCode yang anda masukkan adalah benar</p>
                        </div>
                    </div>
                </div>
            <?php } ?>
    ...
    function getmylocation(){
     ...
     <script type="text/javascript">
      $(document).ready(function() {  
        navigator.geolocation.getCurrentPosition(onSuccess, onError, {timeout:30000});  //{timeout:10000}
