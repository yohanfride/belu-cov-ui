...
class MY_Model extends CI_Model {
    ...
    function page($jml='', $perhalaman='' ,$hal=''){
        ...
        $str = ( ($hal-1) * $perhalaman ) + 1;
        $end = $str + $perhalaman - 1; 

        $output = '
            <div class="col-sm-12 col-md-5">
                <div class="dataTables_info" id="DataTables_Table_0_info" role="status" aria-live="polite"> Showing '.$str.' to '.$end.' of '.$jml.' entries</div>
            </div>
        ...
        if ($nohalaman > 1){
            ...
            $output .='<li class="paginate_button page-item previous" id="DataTables_Table_0_previous"><a href="?'.$query.'" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li>';
        } else {  
            $output .='<li class="paginate_button page-item previous disabled" id="DataTables_Table_0_previous"><a href="#" aria-controls="DataTables_Table_0" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li>';
        }
        ...
        for($halaman = 1; $halaman <= $jumhalaman; $halaman++)
        {
            ...
            $query = http_build_query($params);
                 if ((($halaman >= $nohalaman - 4) && ($halaman <= $nohalaman + 4)) || ($halaman == 1) || ($halaman == $jumhalaman)) 
                 {   
                    if (($showhalaman == 1) && ($halaman != 2)){  
                        $output .= '<li class="paginate_button page-item "><a href="#" aria-controls="DataTables_Table_0" data-dt-idx="1" tabindex="0" class="page-link">...</a></li>';
                    } 
                    if (($showhalaman != ($jumhalaman - 1)) && ($halaman == $jumhalaman)){  
                        $output .= '<li class="paginate_button page-item "><a href="#" aria-controls="DataTables_Table_0" data-dt-idx="1" tabindex="0" class="page-link">...</a></li>';
                    }
                    if ($halaman == $nohalaman){                    
                        $output.= '<li class="paginate_button page-item active"><a href="#" aria-controls="DataTables_Table_0" data-dt-idx="1" tabindex="0" class="page-link">'.$halaman.'</a></li>';
                    }else{ 
                        $output.= '<li class="paginate_button page-item"><a href="?'.$query.'" aria-controls="DataTables_Table_0" data-dt-idx="1" tabindex="0" class="page-link">'.$halaman.'</a></li>';
                    }
                    $showhalaman = $halaman;          
                 }
        }
        ...
        if ($nohalaman < $jumhalaman){ 
            ...
            $query = http_build_query($params);
            $output.='<li class="paginate_button page-item next disabled" id="DataTables_Table_0_next"><a href="?'.($query).'" aria-controls="DataTables_Table_0" data-dt-idx="2" tabindex="0" class="page-link">Next</a></li>';
        } else {
            $output.='<li class="paginate_button page-item next disabled" id="DataTables_Table_0_next"><a href="#" aria-controls="DataTables_Table_0" data-dt-idx="2" tabindex="0" class="page-link">Next</a></li>';
        } 
    ...
    function page_old($jml='', $perhalaman='' ,$hal=''){
            // jumlah data yang akan ditampilkan per halaman        
        $dataPerhalaman = $perhalaman;
        $showhalaman = 0;
        $nohalaman = 0;
